...
export default Router()
    ...
    .put(`${Endpoints.establishments}/:id`, validateToken, establishmentController.put, establishmentController.sendToFirebase)
    .post(`${Endpoints.establishments}/delivery_district/:storeCode`, tokenController.adminValidation, establishmentController.addDeliveryDistrict, establishmentController.sendDeliveryDistrictEvent)
    ...
    .patch(`${Endpoints.establishments}/delivery_district/:storeCode/:id`, tokenController.adminValidation, establishmentController.updateDeliveryDistrict, establishmentController.sendDeliveryDistrictEvent)
    .delete(`${Endpoints.establishments}/delivery_district/:storeCode/:id`, tokenController.adminValidation, establishmentController.deleteDeliveryDistrict, establishmentController.sendDeliveryDistrictDeleteEvent)