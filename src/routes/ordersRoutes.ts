...
export default express.Router()
    ...
    .patch(`${Endpoints.orders}/delivery_orders/:id`, orderController.updateDeliveryOrder, orderMiddleware.manageDeliveryOrder, orderMiddleware.addPreparationOrder, spoolMiddleware.printerSpoolMiddleware)
