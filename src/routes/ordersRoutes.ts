...
export default express.Router()
    ...
    .get(`${Endpoints.orders}/delivery_orders/:storeCode/:id`, orderController.findDeliveryOrderById)
    .post(`${Endpoints.orders}/delivery_orders/:storeCode`, orderController.requestDeliveryOrders, orderMiddleware.sendDeliveryOrderNotification, orderMiddleware.sendDataToFirebase)
