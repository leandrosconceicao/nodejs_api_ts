...
export default express.Router()
    ...
    .get(`${Endpoints.orders}/delivery_orders/:storeCode`, orderController.findAllDeliveryOrders)
    ...
    .patch(`${Endpoints.orders}/delivery_orders/:storeCode/:id`, orderController.updateDeliveryOrder, orderMiddleware.manageDeliveryOrder, orderMiddleware.addPreparationOrder, spoolMiddleware.printerSpoolMiddleware)
