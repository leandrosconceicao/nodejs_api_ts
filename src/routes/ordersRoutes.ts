...
export default express.Router()
    ...
    .get(`${Endpoints.orders}/delivery_orders/:storeCode`, tokenController.userValidation, orderController.findAllDeliveryOrders)
    .get(`${Endpoints.orders}/delivery_orders/:storeCode/:id`, tokenController.userValidation, orderController.findDeliveryOrderById)
    .post(`${Endpoints.orders}/delivery_orders/:storeCode`, tokenController.userValidation, orderController.requestDeliveryOrders, orderMiddleware.sendDeliveryOrderNotification)
    .patch(`${Endpoints.orders}/delivery_orders/:storeCode/:id`, tokenController.userValidation, orderController.updateDeliveryOrder, orderMiddleware.manageDeliveryOrder, orderMiddleware.addPreparationOrder, spoolMiddleware.printerSpoolMiddleware)
    .delete(`${Endpoints.orders}/delivery_orders/:storeCode/:id`, tokenController.userValidation, orderController.cancelDeliveryOrder)
